...
public class BoardDBBean {
	...
	public void insertArticle(BoardDataBean article) throws Exception {
		...
		try {
			...
			sql ="insert into board(num,writer,email,subject,password,reg_date,";
	...
	public List myArticles(String id) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		List articleList=null;
	...
	public int myArticleCount(String id) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		int x=0;
