          ...
          <td colspan="3" bgcolor="<%=title_c%>"   align="center">
            ...
            <input type="button"  value="회원가입" 
			 ...
			 <input type="button"  value="게시판" 
            		onclick="javascript:window.location='/jsp/board/list.jsp'">            		
          </td></form></tr></table>
     <%}else{%>
       <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
         <tr>
           ...
           <td rowspan="3" bgcolor="<%=value_c%>" align="center">
             ...
             <input type="button"  value="게시판" 
            		onclick="javascript:window.location='/jsp/board/list.jsp'"> 
            <input type="button"  value="나의 작성글" 
            		onclick="javascript:window.location='/jsp/board/mylist.jsp'"> 
            <%
            	String id = (String)session.getAttribute("memId");
            if(id.equals("admin")){
             %>	
             <input type="button"  value="회원 목록" 
            		onclick="javascript:window.location='select.jsp'"> 
             <%} %>
             </form>
         </td>
        </tr>
